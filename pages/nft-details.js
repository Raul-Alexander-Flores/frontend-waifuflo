    ...
    <div className="flexBetweenStart my-5">
      <div className="flex-1 flexStartCenter">
        ...
        <div className="flexCenterStart ml-5 flex-col">
          ...
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm minlg:text-xl">{shortenAddress(nft.name)}</p>
...
const NFTdetails = () => {
  ...
  const [nft, setNft] = useState({ image: '', tokenId: '', name: '', price: '', seller: '' });
    ...
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        <div className="relative w-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 h-557 ">
          <Image src={nft.image || images[`nft${nft.i}`]}     width={500}
            height={500}  className=" rounded-xl shadow-lg" layout="fill" />
        </div>
      </div>
      ...
      <Modal
        ...
        body={(
          <div className="flexCenter flex-col text-center">
            <div className="relative w-42 h-52">
              <Loader />
            </div>
          </div>
      ...
      <Modal
        ...
        footer={(
          <div className="flexCenter flex-row sm:flex-col">
            <Button
