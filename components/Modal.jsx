...
const Modal = ({ header, footer, body, handleClose }) => {
  ...
  return (
    <div className="flexCenter fixed inset-0 z-10 bg-overlay-black animated fadeIn " onClick={handleClickOutside}>
      <div ref={modalRef} className=" w-2/5 minlg:2/4 md:w-11/12 dark:bg-nft-dark bg-white flex flex-col">
        ...
        <div className="flexCenter w-full text-center p-4">
          <h2 className="font-poppins dark:text-white text-nft-black-1 text-normal text-2xl">{header}</h2>
